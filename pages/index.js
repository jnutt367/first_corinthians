...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Paul's first Letter to the Church in Corinth</title>
 ...
 <iframe<iframe width="100%" height="315" src="https://www.youtube.com/embed/yiHf8klCCc4" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                               
                                  </div>
